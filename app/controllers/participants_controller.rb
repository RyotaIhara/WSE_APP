class ParticipantsController < ApplicationController
  ...
  def participantEvent
    ...
    if @participants.save
      redirect_to :my_event, notice: "企画に参加登録しました。"
    else
      redirect_to :my_event, notice: "予期せぬエラーが発生しました。"
    end
  end
  ...
  def confirmEvent
    ...
    @participants.update(event_participation_flg: true)
  end
